...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
  ...
  <form name="form1" method="post" action="useradd.jsp">
    <table width="511" height="322" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td height="320"><p align="center" >&nbsp;</p>
          ...
          <tr>
            ...
            <td width="272">
              <input name="passwordconfirm" type="password" id="passwordconfirm" size="15" maxlength="20">
            </td>
          </tr>
          <tr>
            <td width="171" align="right">真实姓名：</td>
            <td width="272">
              <input name="username" type="text" id="username" size="10" maxlength="20">
            </td>
          </tr>
          <tr>
            <td width="171" align="right">联系地址：</td>
            <td width="272">
              <input type="text" name="address" maxlength="100" size="50"></td>
          </tr>
          <tr>
            <td width="171" align="right">联系电话：</td>
            <td width="272">
              <input type="text" name="phone" maxlength="20" size="16">
            </td>
          </tr>
          <tr>
